"""
Fine-tune Qwen3-Embedding-4B on EU AI Act query-chunk pairs
using LoRA + Matryoshka + CachedMNRL.

4B in bf16 = ~8GB model weights. With activations, optimizer states,
and RMSNorm fp32 upcast, full fine-tuning would exceed 32GB VRAM.
...
if __name__ == "__main__":
    ...
    # Training config — conservative for 4B LoRA on 32GB
    BATCH_SIZE = 128
    MINI_BATCH_SIZE = 2  # 4B is ~7x larger than 0.6B
    GRAD_ACCUM = 1
    EVAL_BATCH_SIZE = 2
    EPOCHS = 3
    ...
    training_args = SentenceTransformerTrainingArguments(
        ...
        run_name="qwen3-4b-dutch-regulations-lora-mnrl",
        report_to="wandb",
    )
