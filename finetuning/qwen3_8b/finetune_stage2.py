"""
Stage 2 fine-tuning of Qwen3-Embedding-8B with hard negatives.
...
def load_stage1_model(
    stage1_path: Path,
    base_model_name: str,
    card_name="Qwen3-Embedding-8B EU AI Act NL LoRA Hard Neg Matryoshka",
):
...
if __name__ == "__main__":
    ...
    TRAIN_DIR = (
        PROJECT_ROOT / "data" / "processed" / "qwen3_8b_train_hard_neg"
    )
    EVAL_DIR = PROJECT_ROOT / "data" / "processed" / "eval"
    OUTPUT_DIR = PROJECT_ROOT / "models" / "qwen3_8b_stage2"
